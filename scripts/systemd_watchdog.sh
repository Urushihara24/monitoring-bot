...
HEALTHCHECK_CHAT_AUTOREPLY_MAX_AGE_SECONDS="${HEALTHCHECK_CHAT_AUTOREPLY_MAX_AGE_SECONDS:-$((HEALTHCHECK_MAX_AGE_SECONDS * 2))}"
HEALTHCHECK_FAIL_ON_CHAT_AUTOREPLY_ERROR="${HEALTHCHECK_FAIL_ON_CHAT_AUTOREPLY_ERROR:-false}"
...
echo "[watchdog] hc_max_age=${HEALTHCHECK_MAX_AGE_SECONDS}s"
echo "[watchdog] hc_chat_max_age=${HEALTHCHECK_CHAT_AUTOREPLY_MAX_AGE_SECONDS}s"
echo "[watchdog] hc_chat_fail_on_error=${HEALTHCHECK_FAIL_ON_CHAT_AUTOREPLY_ERROR}"

restart_reason=""

if ! HEALTHCHECK_DB_PATH="${APP_DIR}/data/state.db" \
    HEALTHCHECK_MAX_AGE_SECONDS="${HEALTHCHECK_MAX_AGE_SECONDS}" \
    HEALTHCHECK_CHAT_AUTOREPLY_MAX_AGE_SECONDS="${HEALTHCHECK_CHAT_AUTOREPLY_MAX_AGE_SECONDS}" \
    HEALTHCHECK_FAIL_ON_CHAT_AUTOREPLY_ERROR="${HEALTHCHECK_FAIL_ON_CHAT_AUTOREPLY_ERROR}" \
