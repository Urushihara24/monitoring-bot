...
- **Автоматическое следование за ценой конкурента** с отступом 0.0051₽
- **Точность цен до 4 знаков** (0.3349₽ вместо 0.33₽)
...
**Примечание:** Бот всегда следует за ценой конкурента по формуле: `цена_конкурента - 0.0051`. Например:
- Конкурент: 0.34₽ → Наша цена: 0.3349₽
- Конкурент: 0.33₽ → Наша цена: 0.3249₽
- Конкурент: 0.30₽ → Наша цена: 0.2949₽
...
| `CHECK_INTERVAL` | Интервал проверки конкурентов (сек) | `600` (10 мин) |
